...
function About() {
  return (
    ...
    <section class="about-section">
      ...
      <p>
        <b>MoviesGo</b> is a movie database site hoping to satisfy the cinema needs of movie
      ...
      <p>
        Created by <a href="https://mbui.bcitwebdeveloper.ca/">Mina Bui</a> and <a href="https://vnguyen.bcitwebdeveloper.ca/">Vinson Nguyen</a>.
        Made for the BCIT <a href="https://bcitwebdeveloper.ca/">Technical Web Designer</a> Program.
      </p>
    </section>
